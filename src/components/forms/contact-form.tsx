        ...
        <form onSubmit={handleSubmit} className="px-8 pb-8 max-w-3xl mx-auto">
            <div className="grid grid-cols-1 gap-2">
                <div className="grid grid-cols-1 gap-2 justify-evenly sm:grid-cols-2">
                    <Input name="name" id="name" onChange={handleChange} placeholder='Enter your name...' inputClass='' />
                    <Input name="email" id="email" onChange={handleChange} placeholder='Enter your email...' inputClass="" />
                </div>
                <Input name="message" id="message" onChange={handleChange} inputType="textarea" placeholder='Enter your message...' type="textarea" />
            </div>
